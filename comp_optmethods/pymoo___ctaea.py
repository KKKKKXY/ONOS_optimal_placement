...
def optimize(graph):
    ...
    algorithm = CTAEA(
        # pop_size=pop_size, # TypeError: pymoo.algorithms.base.genetic.GeneticAlgorithm.__init__() got multiple values for keyword argument 'pop_size'
                      ref_dirs=ref_dirs,
...
def main():
    ...
    # outputfile = 'res_bc_simple_ctaea.pkl'
    # outputfile = 'res_bc_Cogent_ctaea.pkl'
    # outputfile = 'res_bc_UsCarrier_ctaea.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_ctaea.pkl'
    # outputfile = 'res_bc_Colt_ctaea.pkl'
    # outputfile = 'res_bc_Funet_ctaea.pkl'
    # outputfile = 'res_bc_Abvt_ctaea.pkl'
    # outputfile = 'res_bc_Intellifiber_ctaea.pkl'
    # outputfile = 'res_bc_DialtelecomCz_ctaea.pkl'
    # outputfile = 'res_bc_TataNld_ctaea.pkl'
    # outputfile = 'res_bc_Kdl_ctaea.pkl'
    # outputfile = 'res_bc_Internode_ctaea.pkl'
    # outputfile = 'res_bc_Missouri_ctaea.pkl'
    # outputfile = 'res_bc_Ion_ctaea.pkl'
    # outputfile = 'res_bc_Ntelos_ctaea.pkl'
    outputfile = 'res_bc_Palmetto_ctaea.pkl'
