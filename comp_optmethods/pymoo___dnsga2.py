...
class ONOSControllerPlacement(ElementwiseProblem):
    def __init__(self, num_nodes, distance_matrix, shortest_paths, graph, **kwargs):
        super().__init__(n_var=2*num_nodes, 
                         n_obj=4, 
                        #  n_constr=2, # AssertionError: DNSGA2 only works for unconstrained problems.
                         xl=0, xu=1, 
                         **kwargs)
...
def optimize(graph):
    ...
    dt = end - start
    print(f'DNSGA2 - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_dnsga2.pkl'
    # outputfile = 'res_bc_Cogent_dnsga2.pkl'
    # outputfile = 'res_bc_UsCarrier_dnsga2.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_dnsga2.pkl'
    # outputfile = 'res_bc_Colt_dnsga2.pkl'
    # outputfile = 'res_bc_Funet_dnsga2.pkl'
    # outputfile = 'res_bc_Abvt_dnsga2.pkl'
    # outputfile = 'res_bc_Intellifiber_dnsga2.pkl'
    # outputfile = 'res_bc_DialtelecomCz_dnsga2.pkl'
    # outputfile = 'res_bc_TataNld_dnsga2.pkl'
    # outputfile = 'res_bc_Kdl_dnsga2.pkl'
    # outputfile = 'res_bc_Internode_dnsga2.pkl'
    # outputfile = 'res_bc_Missouri_dnsga2.pkl'
    # outputfile = 'res_bc_Ion_dnsga2.pkl'
    # outputfile = 'res_bc_Ntelos_dnsga2.pkl'
    outputfile = 'res_bc_Palmetto_dnsga2.pkl'
