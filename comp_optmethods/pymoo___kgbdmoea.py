...
class ONOSControllerPlacement(ElementwiseProblem):
    def __init__(self, num_nodes, distance_matrix, shortest_paths, graph, **kwargs):
        super().__init__(n_var=2*num_nodes, 
                         n_obj=4, 
                        #  n_constr=2, # AssertionError: KGB-DMOEA only works for unconstrained problems.
                         xl=0, xu=1, 
                         **kwargs)
...
def optimize(graph):
    ...
    dt = end - start
    print(f'KGBDMOEA - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_kgbdmoea.pkl'
    # outputfile = 'res_bc_Cogent_kgbdmoea.pkl'
    # outputfile = 'res_bc_UsCarrier_kgbdmoea.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_kgbdmoea.pkl'
    # outputfile = 'res_bc_Colt_kgbdmoea.pkl'
    # outputfile = 'res_bc_Funet_kgbdmoea.pkl'
    # outputfile = 'res_bc_Abvt_kgbdmoea.pkl'
    # outputfile = 'res_bc_Intellifiber_kgbdmoea.pkl'
    # outputfile = 'res_bc_DialtelecomCz_kgbdmoea.pkl'
    # outputfile = 'res_bc_TataNld_kgbdmoea.pkl'
    # outputfile = 'res_bc_Kdl_kgbdmoea.pkl'
    # outputfile = 'res_bc_Internode_kgbdmoea.pkl'
    # outputfile = 'res_bc_Missouri_kgbdmoea.pkl'
    # outputfile = 'res_bc_Ion_kgbdmoea.pkl'
    # outputfile = 'res_bc_Ntelos_kgbdmoea.pkl'
    outputfile = 'res_bc_Palmetto_kgbdmoea.pkl'
