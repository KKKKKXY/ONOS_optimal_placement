...
class ONOSControllerPlacement(ElementwiseProblem):
    def __init__(self, num_nodes, distance_matrix, shortest_paths, graph, **kwargs):
        super().__init__(n_var=2*num_nodes, 
                         n_obj=4, 
                        #  n_constr=2, # AssertionError: This implementation of MOEAD does not support any constraints.
                         xl=0, xu=1, 
                         **kwargs)
...
def optimize(graph):
    ...
    algorithm = MOEAD(
        # pop_size=pop_size, # TypeError: pymoo.core.algorithm.LoopwiseAlgorithm.__init__() got multiple values for keyword argument 'pop_size'
                      ref_dirs=ref_dirs,
                    #   n_neighbors=15,
                    #   prob_neighbor_mating=0.7,
                      ...
                      #   eliminate_duplicates=True # TypeError: pymoo.core.algorithm.LoopwiseAlgorithm.__init__() got multiple values for keyword argument 'eliminate_duplicates'
                      )
...
def main():
    ...
    # outputfile = 'res_bc_simple_moead.pkl'
    # outputfile = 'res_bc_Cogent_moead.pkl'
    # outputfile = 'res_bc_UsCarrier_moead.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_moead.pkl'
    # outputfile = 'res_bc_Colt_moead.pkl'
    # outputfile = 'res_bc_Funet_moead.pkl'
    # outputfile = 'res_bc_Abvt_moead.pkl'
    # outputfile = 'res_bc_Intellifiber_moead.pkl'
    # outputfile = 'res_bc_DialtelecomCz_moead.pkl'
    # outputfile = 'res_bc_TataNld_moead.pkl'
    # outputfile = 'res_bc_Kdl_moead.pkl'
    # outputfile = 'res_bc_Internode_moead.pkl'
    # outputfile = 'res_bc_Missouri_moead.pkl'
    # outputfile = 'res_bc_Ion_moead.pkl'
    # outputfile = 'res_bc_Ntelos_moead.pkl'
    outputfile = 'res_bc_Palmetto_moead.pkl'
