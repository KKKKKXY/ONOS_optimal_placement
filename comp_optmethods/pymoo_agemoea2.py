...
def optimize(graph):
    ...
    algorithm = AGEMOEA2(pop_size=pop_size,
    ...
    dt = end - start
    print(f'AGEMOEA2 - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_agemoea2.pkl'
    # outputfile = 'res_bc_Cogent_agemoea2.pkl'
    # outputfile = 'res_bc_UsCarrier_agemoea2.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_agemoea2.pkl'
    # outputfile = 'res_bc_Colt_agemoea2.pkl'
    # outputfile = 'res_bc_Funet_agemoea2.pkl'
    # outputfile = 'res_bc_Abvt_agemoea2.pkl'
    # outputfile = 'res_bc_Intellifiber_agemoea2.pkl'
    # outputfile = 'res_bc_DialtelecomCz_agemoea2.pkl'
    # outputfile = 'res_bc_TataNld_agemoea2.pkl'
    # outputfile = 'res_bc_Kdl_agemoea2.pkl'
    # outputfile = 'res_bc_Internode_agemoea2.pkl'
    # outputfile = 'res_bc_Missouri_agemoea2.pkl'
    # outputfile = 'res_bc_Ion_agemoea2.pkl'
    # outputfile = 'res_bc_Ntelos_agemoea2.pkl'
    outputfile = 'res_bc_Palmetto_agemoea2.pkl'
