...
def main():
    ...
    # outputfile = 'res_bc_simple_nsga2.pkl'
    # outputfile = 'res_bc_Cogent_nsga2.pkl'
    # outputfile = 'res_bc_UsCarrier_nsga2.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_nsga2.pkl'
    # outputfile = 'res_bc_Colt_nsga2.pkl'
    # outputfile = 'res_bc_Funet_nsga2.pkl'
    # outputfile = 'res_bc_Abvt_nsga2.pkl'
    # outputfile = 'res_bc_Intellifiber_nsga2.pkl'
    # outputfile = 'res_bc_DialtelecomCz_nsga2.pkl'
    # outputfile = 'res_bc_TataNld_nsga2.pkl'
    # outputfile = 'res_bc_Kdl_nsga2.pkl'
    # outputfile = 'res_bc_Internode_nsga2.pkl'
    # outputfile = 'res_bc_Missouri_nsga2.pkl'
    # outputfile = 'res_bc_Ion_nsga2.pkl'
    # outputfile = 'res_bc_Ntelos_nsga2.pkl'
    outputfile = 'res_bc_Palmetto_nsga2.pkl'
