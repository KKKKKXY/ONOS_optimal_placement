...
def main():
    ...
    # outputfile = 'res_bc_simple_nsga3.pkl'
    # outputfile = 'res_bc_Cogent_nsga3.pkl'
    # outputfile = 'res_bc_UsCarrier_nsga3.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_nsga3.pkl'
    # outputfile = 'res_bc_Colt_nsga3.pkl'
    # outputfile = 'res_bc_Funet_nsga3.pkl'
    # outputfile = 'res_bc_Abvt_nsga3.pkl'
    # outputfile = 'res_bc_Intellifiber_nsga3.pkl'
    # outputfile = 'res_bc_DialtelecomCz_nsga3.pkl'
    # outputfile = 'res_bc_TataNld_nsga3.pkl'
    # outputfile = 'res_bc_Kdl_nsga3.pkl'
    # outputfile = 'res_bc_Internode_nsga3.pkl'
    # outputfile = 'res_bc_Missouri_nsga3.pkl'
    # outputfile = 'res_bc_Ion_nsga3.pkl'
    # outputfile = 'res_bc_Ntelos_nsga3.pkl'
    outputfile = 'res_bc_Palmetto_nsga3.pkl'
