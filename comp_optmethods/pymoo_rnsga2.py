...
def optimize(graph):
    ...
    algorithm = RNSGA2(ref_points=ref_points,
                        pop_size=pop_size,
                        # epsilon=0.01,
                        # normalization='front',
                        # weights=None,
    ...
    dt = end - start
    print(f'RNSGA2 - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_rnsga2.pkl'
    # outputfile = 'res_bc_Cogent_rnsga2.pkl'
    # outputfile = 'res_bc_UsCarrier_rnsga2.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_rnsga2.pkl'
    # outputfile = 'res_bc_Colt_rnsga2.pkl'
    # outputfile = 'res_bc_Funet_rnsga2.pkl'
    # outputfile = 'res_bc_Abvt_rnsga2.pkl'
    # outputfile = 'res_bc_Intellifiber_rnsga2.pkl'
    # outputfile = 'res_bc_DialtelecomCz_rnsga2.pkl'
    # outputfile = 'res_bc_TataNld_rnsga2.pkl'
    # outputfile = 'res_bc_Kdl_rnsga2.pkl'
    # outputfile = 'res_bc_Internode_rnsga2.pkl'
    # outputfile = 'res_bc_Missouri_rnsga2.pkl'
    # outputfile = 'res_bc_Ion_rnsga2.pkl'
    # outputfile = 'res_bc_Ntelos_rnsga2.pkl'
    outputfile = 'res_bc_Palmetto_rnsga2.pkl'
