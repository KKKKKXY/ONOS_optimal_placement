...
def optimize(graph):
    ...
    # ref_points = np.array([[2, 3, 100, 0.1]])
    ref_points = np.array([[181, 77, 3922.81875, 1.70537209]])
    algorithm = RNSGA3(
        # pop_size=pop_size, #TypeError: pymoo.algorithms.moo.nsga3.NSGA3.__init__() got multiple values for keyword argument 'pop_size'
                        ref_points=ref_points,
                        pop_per_ref_point=84,
                        # mu=0.1,
    ...
    dt = end - start
    print(f'RNSGA3 - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_rnsga3.pkl'
    # outputfile = 'res_bc_Cogent_rnsga3.pkl'
    # outputfile = 'res_bc_UsCarrier_rnsga3.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_rnsga3.pkl'
    # outputfile = 'res_bc_Colt_rnsga3.pkl'
    # outputfile = 'res_bc_Funet_rnsga3.pkl'
    # outputfile = 'res_bc_Abvt_rnsga3.pkl'
    # outputfile = 'res_bc_Intellifiber_rnsga3.pkl'
    # outputfile = 'res_bc_DialtelecomCz_rnsga3.pkl'
    # outputfile = 'res_bc_TataNld_rnsga3.pkl'
    # outputfile = 'res_bc_Kdl_rnsga3.pkl'
    # outputfile = 'res_bc_Internode_rnsga3.pkl'
    # outputfile = 'res_bc_Missouri_rnsga3.pkl'
    # outputfile = 'res_bc_Ion_rnsga3.pkl'
    # outputfile = 'res_bc_Ntelos_rnsga3.pkl'
    outputfile = 'res_bc_Palmetto_rnsga3.pkl'
