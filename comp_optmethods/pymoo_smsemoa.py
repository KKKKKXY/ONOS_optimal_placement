...
def optimize(graph):
    ...
    dt = end - start
    print(f'SMSEMOA - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_smsemoa.pkl'
    # outputfile = 'res_bc_Cogent_smsemoa.pkl'
    # outputfile = 'res_bc_UsCarrier_smsemoa.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_smsemoa.pkl'
    # outputfile = 'res_bc_Colt_smsemoa.pkl'
    # outputfile = 'res_bc_Funet_smsemoa.pkl'
    # outputfile = 'res_bc_Abvt_smsemoa.pkl'
    # outputfile = 'res_bc_Intellifiber_smsemoa.pkl'
    # outputfile = 'res_bc_DialtelecomCz_smsemoa.pkl'
    # outputfile = 'res_bc_TataNld_smsemoa.pkl'
    # outputfile = 'res_bc_Kdl_smsemoa.pkl'
    # outputfile = 'res_bc_Internode_smsemoa.pkl'
    # outputfile = 'res_bc_Missouri_smsemoa.pkl'
    # outputfile = 'res_bc_Ion_smsemoa.pkl'
    # outputfile = 'res_bc_Ntelos_smsemoa.pkl'
    outputfile = 'res_bc_Palmetto_smsemoa.pkl'
