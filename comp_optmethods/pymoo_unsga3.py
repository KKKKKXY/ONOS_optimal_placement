...
def optimize(graph):
    ...
    dt = end - start
    print(f'UNSGA3 - Elapsed time: {dt}')
...
def main():
    ...
    # outputfile = 'res_bc_simple_unsga3.pkl'
    # outputfile = 'res_bc_Cogent_unsga3.pkl'
    # outputfile = 'res_bc_UsCarrier_unsga3.pkl'
    # outputfile = 'res_bc_HiberniaGlobal_unsga3.pkl'
    # outputfile = 'res_bc_Colt_unsga3.pkl'
    # outputfile = 'res_bc_Funet_unsga3.pkl'
    # outputfile = 'res_bc_Abvt_unsga3.pkl'
    # outputfile = 'res_bc_Intellifiber_unsga3.pkl'
    # outputfile = 'res_bc_DialtelecomCz_unsga3.pkl'
    # outputfile = 'res_bc_TataNld_unsga3.pkl'
    # outputfile = 'res_bc_Kdl_unsga3.pkl'
    # outputfile = 'res_bc_Internode_unsga3.pkl'
    # outputfile = 'res_bc_Missouri_unsga3.pkl'
    # outputfile = 'res_bc_Ion_unsga3.pkl'
    # outputfile = 'res_bc_Ntelos_unsga3.pkl'
    outputfile = 'res_bc_Palmetto_unsga3.pkl'
